                ...
                <div className="info-panel card">
                    ...
                    <div className="card-body">
                        ...
                        <div className="info-group">
                            ...
                            <div className="row"><div className="col-6">Destination:</div><div className="col-6 text-right">
                                <img
                                    src={blue_pin}
                                    alt={"Blue Pin"}
                                    width="20"
                        ...
                        <div className="info-group">
                            <div className="row"><div className="col-6">Link ID:</div><div className="col-6 text-right">{selected_link.Id}</div></div>
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-4">
                                ...
                                <div className="info-group container-fluid">
                                    <div className="row"><div className="col-6">Vehicle ID:</div><div className="col-6 text-right info-value">{selected_vehicle.id}</div></div>
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-4">
                                <h4 className="card-title">Selection</h4>
                                <div className="info-group container-fluid">
                                     <div className="row"><div className="col-6">Link ID:</div><div className="col-6 text-right info-value">{selected_link.Id}</div></div>
                                     <div className="row"><div className="col-6">Link length:</div><div className="col-6 text-right info-value">{selected_link.length.toFixed(1)} m</div></div>
                                     <div className="row"><div className="col-6">Speed limit:</div><div className="col-6 text-right info-value">{selected_link.freeflowsp} km/h</div></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="card-body">
                        <div className="row">
                            ...
                            <div className="col-3">
                                ...
                                <div className="info-group container-fluid">
                                    <div className="row"><div className="col-9">Vehicle ID:</div><div className="col-3 text-right info-value">{selected_vehicle ? selected_vehicle.id : '--'}</div></div>
                                    <div className="row"><div className="col-9">Origin:</div><div className="col-3 text-right">
                                        <img
                                            src={red_pin}
                                            alt="Origin pin"
